...
def startup_master_alert(CP: car.CarParams, CS: car.CarState, sm: messaging.SubMaster, metric: bool, soft_disable_time: int) -> Alert:
  ...
  return StartupAlert("항상 전방주시를 하고 핸들을 잡아야 합니다", alert_status=AlertStatus.frogpilot)
...
EventName.startup: {
  ...
  EventName.gpsMalfunction: {
    ET.PERMANENT: NormalPermanentAlert("GPS 수신 오류", "하드웨어 결함 체크 필요"),
  },
